...
class XmlHelper
{
     ...
     * @throws Exception
     */
    public function setDomProperties(array $domProperties): XmlHelper
    {
    ...
    {
        if ($value instanceof WC_Product_Download) {
            return;
        }
     ...
     * @throws DOMException
     */
    public function appendProduct(ProductModel $product, $rootElement = ''): bool
    {
        $array = [];

        array_push($array, $product->getIdentifier());
        array_push($array, $product->getBrand());
        array_push($array, $product->getCategories());
        array_push($array, $product->getOptions());
